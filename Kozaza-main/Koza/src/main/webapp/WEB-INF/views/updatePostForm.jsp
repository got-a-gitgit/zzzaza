...
<body>
    ...
    <script>
    		...
    		$(document).ready(function(){
        		// 
        		switch(${boardData.contentVO.contentType}){
        		case 1 : {
        				$("input:radio[name='contentType']:radio[value='1']").prop('checked', true);
        				$("input:radio[name='contentType']:radio[value='2']").prop('checked', false);
        				$("input:radio[name='contentType']:radio[value='3']").prop('checked', false);
        				break;
            		}
        		case 2 : {
    					$("input:radio[name='contentType']:radio[value='1']").prop('checked', false);
    					$("input:radio[name='contentType']:radio[value='2']").prop('checked', true);
    					$("input:radio[name='contentType']:radio[value='3']").prop('checked', false);
    					break;
            		}
        		case 3 : {
						$("input:radio[name='contentType']:radio[value='1']").prop('checked', false);
						$("input:radio[name='contentType']:radio[value='2']").prop('checked', false);
						$("input:radio[name='contentType']:radio[value='3']").prop('checked', true);
						break;
        			}
        		}

        		if("${boardData.rateVO.rateBug}" == "true"){
        			$("input:radio[name='rateBug']:radio[value='true']").prop('checked', true);
					$("input:radio[name='rateBug']:radio[value='false']").prop('checked', false);
            	}else{
    				$("input:radio[name='rateBug']:radio[value='true']").prop('checked', false);
					$("input:radio[name='rateBug']:radio[value='false']").prop('checked', true);
        		}

        		if("${boardData.rateVO.rateNoise}" == "true"){
        			$("input:radio[name='rateNoise']:radio[value='true']").prop('checked', true);
					$("input:radio[name='rateNoise']:radio[value='false']").prop('checked', false);
            	}else{
    				$("input:radio[name='rateNoise']:radio[value='true']").prop('checked', false);
					$("input:radio[name='rateNoise']:radio[value='false']").prop('checked', true);
        		}
        		if("${boardData.rateVO.rateLeak}" == "true"){
        			$("input:radio[name='rateLeak']:radio[value='true']").prop('checked', true);
					$("input:radio[name='rateLeak']:radio[value='false']").prop('checked', false);
            	}else{
    				$("input:radio[name='rateLeak']:radio[value='true']").prop('checked', false);
					$("input:radio[name='rateLeak']:radio[value='false']").prop('checked', true);
        		}
        		if("${boardData.rateVO.rateFungi}" == "true"){
        			$("input:radio[name='rateFungi']:radio[value='true']").prop('checked', true);
					$("input:radio[name='rateFungi']:radio[value='false']").prop('checked', false);
            	}else{
    				$("input:radio[name='rateFungi']:radio[value='true']").prop('checked', false);
					$("input:radio[name='rateFungi']:radio[value='false']").prop('checked', true);
        		}
		...
		<div class="grid-container">
			...
			<div id="textArea_part" class="grid-contents">
				...
				<input type="text" id = "postTitle" name="contentTitle" class="form-control"
					placeholder="제목을 입력하세요." value="${boardData.contentVO.contentTitle }">

				<div>
					<label for="disabledInput">주소</label>
					<input class="form-control"	id="disabledInput" type="text"
						placeholder="Disabled input here..."
						value="${boardData.houseVO.houseAddress} ${boardData.houseVO.houseSpecificAddress}" disabled>
				</div>
				...
				<div id=Date_residencePeriod>
					<label for="fromDate">거주 시작시기 <input type="month"
						name="rateStartLiving" id="fromDate" class="form-control" value="${boardData.rateVO.rateStartLiving }"></label>
					<label for="toDate">거주 종료시기 <input type="month"
						name="rateEndLiving" id="toDate" class="form-control" value="${boardData.rateVO.rateEndLiving }"></label>

				</div>

				<div id=Date_visited>
					<label for="visitDate">방문시기 <input type="month"
						name="rateVisitedTime" id="visitDate" class="form-control" value="${boardData.rateVO.rateVisitedTime }"></label>
				</div>
				...
				<textarea style="resize: none" name="contentContent"
					...
					rows="15" placeholder="내용을 입력하세요." >${boardData.contentVO.contentContent}</textarea>
			</div>
			...
			<input type="hidden" name="houseAddress" value="${boardData.houseVO.houseAddress}"/>
			<input type="hidden" name="houseSpecificAddress" value="${boardData.houseVO.houseSpecificAddress}"/>
			<input type="hidden" name="houseImages" value="${boardData.houseVO.houseImages}"/>	
			<input type="hidden" name="houseLatitude" value="${boardData.houseVO.houseLatitude}"/>
			<input type="hidden" name="houseLongitude" value="${boardData.houseVO.houseLongitude}"/>
			<input type="hidden" name="contentRoomNum" value="${boardData.houseVO.houseSpecificAddress }"/>
		</div>
	</form>
